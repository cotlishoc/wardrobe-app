...
def seed_database(db: Session):
    ...
    # 2. Категории
    categories = [
        "Футболки и майки", "Рубашки", "Рубашки и блузки", "Свитеры", 
        "Свитшоты и худи", "Куртки и пальто", "Бомберы", "Ветровки", 
        "Детские куртки", "Жилеты", "Джинсовые куртки", "Кожаные куртки", 
        "Стеганые куртки", "Спортивные куртки", "Брюки", "Джинсы", 
        "Шорты", "Юбки", "Леггинсы", "Платья", "Комбинезоны", 
        "Координированные костюмы", "Купальники", "Кроссовки", 
        "Спортивная обувь", "Ботинки", "Зимние ботинки", "Сандалии", 
        "Шлепанцы", "Слайды", "Домашние тапочки", "Лоферы и мокасины", 
        "Классическая обувь", "Эспадрильи", "Балетки", "Туфли на каблуке", 
        "Мюли", "Детская обувь", "Бюстгальтеры", "Трусы", "Бельевые наборы", 
        "Мужское нижнее белье", "Белье", "Чулочно-носочные изделия", 
        "Детское белье", "Пижамы", "Ночные рубашки", "Халаты", 
        "Сумки", "Рюкзаки", "Сумки через плечо", "Поясные сумки", 
        "Кошельки", "Чемоданы", "Ремни", "Шляпы", "Головные уборы", 
        "Шарфы", "Шарфы и палантины", "Солнцезащитные очки", "Очки", 
        "Галстуки", "Бабочки", "Часы", "Серьги", "Ожерелья", 
        "Подвески", "Браслеты", "Кольца", "Цепочки", "Ювелирные наборы", 
        "Аксессуары для волос", "Плавки", "Спортивные костюмы", 
